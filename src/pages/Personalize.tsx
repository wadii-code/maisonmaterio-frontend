...
export function Personalize() {
  ...
  const buildWhatsAppLink = (): string => {
    const lines = [
      locale === 'fr' ? '🎯 *Demande de personnalisation SWIPO*' : '🎯 *SWIPO Personalization Request*',
      '',
  ...
  return (
    <>
      <Helmet><title>{t('personalize.title')} — SWIPO</title></Helmet>
