      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 border-b border-white/10">
          <div className="max-w-xl mx-auto text-center">
            ...
            <p className="text-gray-400 mb-6">Get the latest on new arrivals, exclusive deals and design inspiration.</p>
        ...
        <div className="py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-3 text-sm text-gray-400 leading-relaxed">
              Premium home decorations, furniture and building materials to illuminate your space.
            </p>
          ...
          <div>
            <h4 className="font-bold text-sm uppercase tracking-wider mb-4 text-gray-300">Rooms</h4>
            <ul className="space-y-2 text-sm text-gray-400">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li className="flex items-center gap-2"><Mail size={14} /><span>hello@swipo.com</span></li>
              <li className="flex items-center gap-2"><Phone size={14} /><span>+1 (800) 794-7660</span></li>
              <li className="flex items-start gap-2"><MapPin size={14} className="shrink-0 mt-0.5" /><span>123 Design St,<br />New York, NY 10001</span></li>
            </ul>
          </div>
        </div>
        ...
        <div className="py-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-500">
          <p>© {new Date().getFullYear()} SWIPO. All rights reserved.</p>
