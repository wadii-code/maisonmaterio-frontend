/**
 * Maison Materiau translation dictionary.
...
export const translations = {
  ...
  fr: {
    ...
    'auth.signInSubtitle': 'Connectez-vous à votre compte Maison Materiau',
    'auth.signUpSubtitle': 'Rejoignez Maison Materiau dès aujourd\'hui',
